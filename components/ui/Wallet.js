      ...
      <div className="grid my-10 items-center justify-center text-center">
        <div className="max-w-sm w-96 rounded-lg overflow-hidden shadow-lg bg-white">
          ...
          <div className="px-6 py-4 ">
            <button
              className="bg-blue-500 w-full hover:bg-blue-700 uppercase text-white font-bold py-2 px-4 border border-blue-700 rounded hover:bg-blue-700"
        ...
        {walletList
          ? walletList.map((element, index) => {
              return (
                <div
                  key={index}
                  className="block w-1/3 mb-2 mx-5 rounded-lg shadow-lg bg-white max-w-sm text-center"
                >
                    ...
                    {element.walletAddress == state.selectedWallet ? (
                      ...
                      >
                        <button
                          ...
                          onClick={() =>
                            setSelectedWalletAddr(element.walletAddress)
                          }
                        >
                          Use Wallet
                        </button>
